...
void GameApp::DrawScene()
{
	...
	// 绘制六边形
	m_pd3dImmediateContext->Draw(6, 0);//画点的个数
...
bool GameApp::InitResource()
{
	...
	{
		//画12个点4个三角形，六边形
		/*{ XMFLOAT3(0.0f, 1.0f, 0.5f), XMFLOAT4(5.0f, 0.0f, 0.0f, 0.0f) },
	...
	// 设置图元类型，设定输入布局
	m_pd3dImmediateContext->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP);//此函数规定各点如何连接去实现怎样的图形
